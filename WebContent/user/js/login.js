function register() {
		...
		ajax("post", "http://localhost:8080/finaltg/UserRegisterServlet", "email="
		...
		function initData(result) {
			...
			window.open("UserShowProductServlet");
		}
	}
	...
	function login() {
		...
		ajax("post", "http://localhost:8080/finaltg/UserLoginServlet", "account="
