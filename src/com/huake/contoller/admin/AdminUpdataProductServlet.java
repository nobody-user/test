...
import com.huake.model.admin.UpdataProductDao;
import com.huake.pojo.Goods;


@WebServlet("/AdminUpdataProductServlet")
public class AdminUpdataProductServlet extends HttpServlet {
	
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		Goods good=uploadImage(request, response);
		UpdataProductDao dao=new UpdataProductDao();
		int res=dao.updata(good);
